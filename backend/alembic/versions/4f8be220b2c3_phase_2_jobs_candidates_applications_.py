...
down_revision: str | None = "ede0c8f1988b"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_duplicate_candidate_links_candidate_id"), "duplicate_candidate_links", ["candidate_id"], unique=False
    )
    op.create_index(
        op.f("ix_duplicate_candidate_links_duplicate_of_candidate_id"),
        "duplicate_candidate_links",
        ["duplicate_of_candidate_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_duplicate_candidate_links_organization_id"), "duplicate_candidate_links", ["organization_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_application_stage_history_application_id"), "application_stage_history", ["application_id"], unique=False
    )
