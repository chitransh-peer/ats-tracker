...
down_revision: Union[str, None] = 'f35477b12fcb'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(
        'fk_clients_created_by_users', 'clients', 'users', ['created_by'], ['id'], ondelete='SET NULL'
    )
    op.create_foreign_key(
        'fk_clients_updated_by_users', 'clients', 'users', ['updated_by'], ['id'], ondelete='SET NULL'
    )
